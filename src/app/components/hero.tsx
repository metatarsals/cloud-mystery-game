...
import GradientBackground from "./gradbg";
...
export default function Hero () {
    ...
    <div className="flex items-center justify-center h-screen px-8">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen text-center px-6 mt-12">
        ...
        some things aren’t meant to be  <span className="bg-gradient-to-r from-cyan-300 via-blue-500 to-indigo-400 bg-clip-text text-transparent text-shadow-lg">
      remembered.
</span>
        </h2>
        ...
        <div className="mt-8">
        <Link className={buttonVariants({ variant: "outline", size: "icon", className: "px-4 py-4 !rounded-full" })} href="/get-started">
